...
List<Modalidades> modalidadesFromJson(String str) => List<Modalidades>.from(
    json.decode(str).map((x) => Modalidades.fromJson(x)));

String modalidadesToJson(List<Modalidades> data) =>
